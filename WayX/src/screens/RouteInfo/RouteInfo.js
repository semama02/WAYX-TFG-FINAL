...
const sol = require("../../assets/tiempo/sol.png")
const sol_nubes = require("../../assets/tiempo/sol_nubes.png")
const nubes = require("../../assets/tiempo/nubes.png")
const lluvioso = require("../../assets/tiempo/lluvioso.png")
...
export default function RouteInfo(props) {
  ...
  const getDatos = async () => {
    const res = await axios.get('https://api.openweathermap.org/data/2.5/weather?q=' +props.route.params.rut.location +'&lang=ES&units=metric&APPID=1d89f0ecc30e4a2ab23f1d00bf2c9c09');
    tiempo = res.data
      ...
      >
        ...
        <ScrollView style={styles.scroll}>
          ...
          <View style={styles.pruebas}>
            {/* <Image
              source={imagen}
              style={{ width: "23%", height: "40%", alignSelf: 'center' }}
            /> */}
            <Text style={styles.input2}>{descripcion}</Text>
            <Text style={styles.input}>Temp: {temp}ºC</Text>
            <Text style={styles.input}>Temp mínima: {tempMin}ºC</Text>
            <Text style={styles.input}>Temp máxima: {tempMax}ºC</Text>
          </View>
